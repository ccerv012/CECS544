CREATE TABLE EMPLOYEE (
    ...
    EMP_ROLE NUMBER,
    CONSTRAINT EMPLOYEE_PK PRIMARY KEY(EMP_USERNAME)
);
...
CREATE TABLE PROGRAM (
    ...
    PRGM_VERSION NUMBER,
    PRGM_RELEASE NUMBER,
    CONSTRAINT PROGRAM_PK PRIMARY KEY(PRGM_NAME,PRGM_RELEASE,PRGM_VERSION)
);
...
CREATE TABLE FUNCTIONAL_AREA (
    ...
    PRGM_ID NUMBER,
    CONSTRAINT FUNCTIONAL_AREA_PK PRIMARY KEY(FAREA_NAME, PRGM_ID)
);
...
CREATE TABLE BUG_REPORTS (
    ...
    REPRODUCIBILITY_STEPS VARCHAR2(500),
    SUGGESTED_FIX VARCHAR2(500),
    REPORTED_BY_NAME VARCHAR2(50),
    REPORT_DATE DATE,
    FAREA_ID NUMBER,
